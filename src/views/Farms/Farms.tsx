  ...
  const farmsList = useCallback(
    (farmsToDisplay, removed: boolean) => {
      ...
      const farmsToDisplayWithAPY: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        //   return farm
        // }
        const cakeRewardPerBlock = new BigNumber(farm.gamePerBlock || 1)
  ...
  return (
    <Page>
      <Heading as="h1" size="lg" color="text" mb="50px" style={{ textAlign: 'center' }}>
        {tokenMode
          ? TranslateString(10002, 'Stake tokens to earn GAME')
      ...
      <Image src="/images/egg/" alt="illustration" width={1352} height={587} responsive />
    </Page>
  )
}
