...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, bnbPrice, ethereum, account }) => {
  ...
  return (
    <FCard>
      {farm.tokenSymbol === 'GAME' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
      ...
      {!removed && (
        <Flex justifyContent="space-between" alignItems="center">
          <Text color="primary">{TranslateString(352, 'APR')}:</Text>
      ...
      <Flex justifyContent="space-between">
        <Text color="primary">{TranslateString(318, 'Earn')}:</Text>
        <Text bold>{earnLabel}</Text>
      </Flex>
      <Flex justifyContent="space-between">
        <Text color="primary">{TranslateString(10001, 'Deposit Fee')}:</Text>
        <Text bold>
