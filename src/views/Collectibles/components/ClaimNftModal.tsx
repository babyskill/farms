...
import { Button, InjectedModalProps, Modal, Text, Flex, AutoRenewIcon } from 'uikit'
...
const ClaimNftModal: React.FC<ClaimNftModalProps> = ({ nft, onSuccess, onClaim, onDismiss }) => {
  ...
  return (
    <Modal title={TranslateString(999, 'You will receive')} onDismiss={onDismiss}>
      <ModalContent>
        <Flex alignItems="center" mb="8px" justifyContent="space-between">
          {TranslateString(999, 'You will receive')}
